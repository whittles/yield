...
export const useProjectStore = defineStore('project', () => {
  ...
  const defaultSkus = [
    ...
    { id: 'sku2', name: 'Wide 12"',     roughWidthStr: '0.800', planeAllowance: 0.025, sanderAllowance: 0.025, finalWidthStr: '0.750', length: 12, tableKerfStr: '1/8', panelDepthStr: '3/4' },
    ...
    { id: 'sku4', name: 'Wide 24"',     roughWidthStr: '0.800', planeAllowance: 0.025, sanderAllowance: 0.025, finalWidthStr: '0.750', length: 24, tableKerfStr: '1/8', panelDepthStr: '3/4' },
  ]
